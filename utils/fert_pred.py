fertilizer_prediction = {
    "N_low": """<b style = "color:#c79c60;">The N value of your soil is low.</b>
        <br/><br/> Please consider the following suggestions which can naturally help to increase the Nitrogen level:
        ...
        <p align="justify">4. <i>Sugar</i> – In limited studies, it was shown that adding sugar to your soil can help potentially increases the amount of nitrogen is your soil. Sugar is partially composed of carbon, an element which attracts and soaks up the nitrogen in the soil. This is similar concept to adding sawdust/woodchips which are high in carbon content.</p>
    ...
    'N_High': """<b style = "color:#c79c60;">The N value of soil is high and might give rise to weeds.</b>
        <br/><br/>Please consider the following suggestions which can naturally help to Decrease the Nitrogen level:
    ...
    'N_No': """<b style = "color:#c79c60;">The N value of your soil is up to the mark</b>.<hr style = "height:2px; background-color:#c79c60;">""",
    'P_low': """<b style = "color:#c79c60;">The P value of your soil is low.</b>
        <br/> <br/>Please consider the following suggestions which can naturally help to increase the Phosphours level:
    ...
    'P_High': """<b style = "color:#c79c60;">The P value of your soil is high.</b>
        <br/> <br/>Please consider the following suggestions which can naturally help to Decrease the Phosphours level:
    ...
    'P_No': """<b style = "color:#c79c60;">The N value of your soil is up to the mark</b>.<hr style = "height:2px; background-color:#c79c60;">""",
    'K_low': """<b style = "color:#c79c60;">The K value of your soil is low.</b>
        <br/><br/>Please consider the following suggestions which can naturally help to increase the Potassium level:
    ...
    'K_High': """<b style = "color:#c79c60;">The K value of your soil is high</b>.
        <br/> <br/>Please consider the following suggestions which can naturally help to Decrease the Potassium level:
    ...
    'K_No': """<b style = "color:#c79c60;">The N value of your soil is up to the mark</b>.<hr style = "height:2px; background-color:#c79c60;">""",
}
